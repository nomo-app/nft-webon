import { Log, type Provider } from 'ethers';
...
/**
 * Fetches nftIDs for a given ERC721 contract and EVM address.
 */
...
function mapTransferLogToERC721Entity(transferLog: Log, nftContractAddress: string): ERC721Entity {
